            ...
            render: (row) => (
                <div className="flex gap-2">
                    ...
                    <button
                        ...
                        className="flex items-center gap-1 p-1 px-2 rounded-lg text-emerald-600 hover:bg-emerald-50 dark:text-emerald-400 dark:hover:bg-emerald-900/30 transition-all duration-300 font-medium text-[10px] border border-emerald-100 dark:border-emerald-900/50 hover:border-emerald-200 dark:hover:border-emerald-800 shadow-sm active:scale-95"
                        title="Edit Member"
                    >
                        <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <button
                        ...
                        className="flex items-center gap-1 p-1 px-2 rounded-lg text-red-600 hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-900/30 transition-all duration-300 font-medium text-[10px] border border-red-100 dark:border-red-900/50 hover:border-red-200 dark:hover:border-red-800 shadow-sm active:scale-95"
                        title="Delete Member"
                    >
                        <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
